...
$sql = "SELECT Title FROM Album WHERE AlbumId = {$_GET['id']};";
...
<div class="container">
  <div class="row">
    ...
    <div class="col-md-6 text-right">
      <h3><i><?php echo $album_name;?> Song(s)</i></h3>
    </div>
  </div>
  <div id="alert_box"></div>
  <hr>
  <?php
	$sql = "SELECT *,a.Title as al_title,m.Name as media_type,g.Name as g_name,t.Name FROM Track t, Album a, Genre g, MediaType m WHERE t.MediaTypeId = m.MediaTypeId and t.AlbumId = a.AlbumId and t.GenreId = g.GenreId and t.status>0 and t.AlbumId={$_GET['id']};";
	$result = $conn->query($sql);
  //var_dump($result);die;
	if ($result->num_rows > 0) {
